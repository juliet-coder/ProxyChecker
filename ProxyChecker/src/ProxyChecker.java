...
public class ProxyChecker {
    public static void main(String[] args) {
        try {
            FileInputStream fin = new FileInputStream("C:/Users/Dom/source/repos/java/ip.txt");
            FileOutputStream fos = new FileOutputStream("C:/Users/Dom/source/repos/java/good_ip.txt");
            String string = "";
            int i;
            while ((i=fin.read())!=-1){
                string += (char)i;
